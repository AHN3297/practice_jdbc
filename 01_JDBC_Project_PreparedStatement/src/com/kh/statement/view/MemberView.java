...
/**
 * alt + shift + j
 * Member View 클래스는 JDBC실습을 위해 생성하였으며,
...
public class MemberView {
	...
	/**
	 * MEMBER 테이블에 INSERT할 값을 사용자가 입력받는 화면을 출력해주는메소드
	 * 
	...
	/**
	 *  회원전체 조회 요청시 Memeber 테이블에 존재하는 모든 회원의 정보를 출력하는 메소드
	 */
	private void findAll() {
		
		System.out.println("\n회원 전체 조회");
		// 데이터 해줘! Controller에게 회원들의 데이터 값 요청
